package nl.ashlyn.casinoanimations.storage.impl;
...
public class MultipleFileFrameStorage implements DataStore {
    ...
    public MultipleFileFrameStorage(String animation) {
        this.dataFolder = CasinoAnimations.INSTANCE.getDataFolder() + "/data/" + animation + "/";
        this.name = animation;
    }

    public void createAnimationData(String animation, World world, String frameLoad) {
        File data = new File(CasinoAnimations.INSTANCE.getAnimationDataFolder());
    ...
    public void setName(String name) {
        new File(this.dataFolder).renameTo(new File(CasinoAnimations.INSTANCE.getDataFolder() + "/data/" + name));
        this.dataFolder = CasinoAnimations.INSTANCE.getDataFolder() + "/data/" + name + "/";
        this.name = name;
    }
}