package nl.ashlyn.casinoanimations.animation.impl;
...
import nl.ashlyn.casinoanimations.api.events.AnimationEndEvent;
import nl.ashlyn.casinoanimations.api.events.AnimationFrameChangeEvent;
import nl.ashlyn.casinoanimations.api.events.AnimationStartEvent;
...
public class BlockAnimation implements IAnimation {
    ...
    public void play(boolean playOnce) {
        running = true;
        runnable = Bukkit.getScheduler().runTaskTimer(CasinoAnimations.INSTANCE, () -> {
