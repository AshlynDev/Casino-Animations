package nl.ashlyn.casinoanimations.api.util;
...
public class AnimationUtil {
    ...
    public static IAnimation loadAnimation(File animation) {
        ...
        if(Bukkit.getWorld(UUID.fromString(settingsYml.getString("world"))) == null) {
            CasinoAnimations.INSTANCE.getLogger().warning("World " + settingsYml.getString("world") + " not found for animation " + animation.getName());
            return null;
        }
