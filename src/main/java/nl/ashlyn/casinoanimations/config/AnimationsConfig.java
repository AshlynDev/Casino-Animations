...
public class AnimationsConfig {
    ...
    public static void load() {
        ...
        CasinoAnimations.INSTANCE.reloadConfig();
        config = CasinoAnimations.INSTANCE.getConfig();
        ...
        CasinoAnimations.INSTANCE.getAnimations().clear();
        if (new File(CasinoAnimations.INSTANCE.getAnimationDataFolder()).exists()) {
            for (File animation : new File(CasinoAnimations.INSTANCE.getAnimationDataFolder()).listFiles()) {
                CasinoAnimations.INSTANCE.getAnimations().put(animation.getName(), AnimationUtil.loadAnimation(animation));
            }
        }
    }
}